...
namespace WebAppPractice_ContosoUniversity.Pages.Students
{
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            if (saveChangesError.GetValueOrDefault()) //indicates whether the method was called after a failure to delete the student object.
            {
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            try
            {
                ...
                await _context.SaveChangesAsync(); //a SQL command is genereated 
