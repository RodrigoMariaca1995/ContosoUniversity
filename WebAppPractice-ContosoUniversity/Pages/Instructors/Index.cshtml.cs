...
using WebAppPractice_ContosoUniversity.Models.SchoolViewModels;  // Add VM
...
namespace WebAppPractice_ContosoUniversity.Pages.Instructors
{
    public class IndexModel : PageModel
    {
        ...
        public async Task OnGetAsync(int? id, int? courseID)
        {
            ...
            if (id != null) //executes when an istructor is selected
            {
            ...
            if (courseID != null) //populates the view model's Enrollments property when a course is selected
            {
